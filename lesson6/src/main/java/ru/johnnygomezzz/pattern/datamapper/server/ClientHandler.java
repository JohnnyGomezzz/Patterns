...
import ru.johnnygomezzz.pattern.datamapper.log.Logger;
                            ...
                            .ifPresentOrElse(
                                    user -> {
                                        if (!server.isLoggedIn(user.getNickname())) {
                                            ...
                                            String initMessage = logHelper.readFromFile(100);
                                            server.sendPrivateMessage(this.name, initMessage);
                                            authCheck = true;
                                        } else {
